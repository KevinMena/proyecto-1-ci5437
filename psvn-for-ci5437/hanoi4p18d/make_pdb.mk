...
%.pdb: abstractor
	...
	@make -f make_pdb.mk `basename $*`.distSummary
...
%.a_star: %.c ../global/a_star.cpp
	$(CXX) $(OPT) ../global/a_star.cpp -include $< -include hanoi_18_pdb.cpp -o $@
	rm -f $*.c

%.ida_star: %.c ../global/ida_star.cpp
	$(CXX) $(OPT) ../global/ida_star.cpp -include $< -include hanoi_18_pdb.cpp -o $@
	rm -f $*.c
